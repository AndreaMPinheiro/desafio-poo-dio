...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Conteúdos Inscritos de Andrea" + devAndrea.getConteudosInscritos());
		devAndrea.progredir();
		devAndrea.progredir();
		System.out.println("-");
		System.out.println("Conteúdos Inscritos de Andrea" + devAndrea.getConteudosInscritos());
		System.out.println("Conteúdos Concluídos de Andrea" + devAndrea.getConteudosConcluidos());
